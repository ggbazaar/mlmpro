...
// ], function () {
    ...
    Route::post('/AdminAdvisorListPost', [UsermlmController::class, 'AdminAdvisorListPost']);
    ...
    Route::post('/getBusinessAndCommissionData', [UsermlmController::class, 'getBusinessAndCommissionData']);
    ...
    Route::post('/AdminListpowerleg', [GetAdvisorList::class, 'AdminListpowerleg']);
